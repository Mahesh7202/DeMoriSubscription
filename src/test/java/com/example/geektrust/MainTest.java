...
class MainTest {
    ...
    void runTest1() {
        ...
        String normalizedActualOutput = normalizeLineSeparators(outputStreamCaptor.toString().trim());
        Assertions.assertEquals(normalizedExpectedOutput, normalizedActualOutput);
    }
